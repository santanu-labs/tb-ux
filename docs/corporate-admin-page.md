 ...
 Let me read both documents fully to understand the complete scope.  

Read [](file:///Users/saan-personal/Documents/tb-ux/docs/project-context.md#1-1), lines 1 to 400

Read [](file:///Users/saan-personal/Documents/tb-ux/docs/corporate-admin-page.md)

Read [](file:///Users/saan-personal/Documents/tb-ux/docs/project-context.md#401-401), lines 401 to 674

Now let me see the current state of the project structure: 

Read [](file:///Users/saan-personal/Documents/tb-ux)
...
**Shared Components (from shadcn-tokens.css):**
...
1. Open each HTML file in browser — all should render without errors
2. Navigation links between employee pages work
3. Admin sidebar navigation works across all admin pages
4. Responsive check: resize to mobile/tablet — all layouts should adapt
5. Stepper interactions work on onboarding and CSV import flows
6. Tab switching works on employee detail and settings pages
...
- **Payment is display-only** — clear disclaimer on plan summary per MVP scope
- **Compliance built-in** — accept-terms onboarding step, data privacy in profile, audit logs in admin